package com.example.huanjiayang.Week09ContentProviderDetailAct.data;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch(match_code){
            case WEATHER:{
                ...
                if (_id > 0)
                    retUri = WeatherDataModel.weatherEntry.buildWeatherUriWithDayNo(_id);
                else
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch(match_code){
            case WEATHER:{
                SQLiteDatabase db = myDBHelper.getWritableDatabase();
                myCursor = db.query(
                        WeatherDataModel.weatherEntry.TABLE_NAME, // Table to Query
                        projection,
            ...
            case WEATHER_WITH_ID:{
                ...
                Log.i("Week09WeatherProvider", "querying for WEATHER_WITH_ID with ID: "+ContentUris.parseId(uri));
                Log.i("Week09WeatherProvider", myCursor.getCount()+"");
                break;
            }
            default:
