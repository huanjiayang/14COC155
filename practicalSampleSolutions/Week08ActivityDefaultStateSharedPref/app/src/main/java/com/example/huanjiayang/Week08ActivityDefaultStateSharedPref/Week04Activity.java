package com.example.huanjiayang.Week08ActivityDefaultStateSharedPref;
...
public class Week04Activity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("Week08ActivityLifeCycle","Main Activity onCreate()");
        ...
        SharedPreferences myPref = getSharedPreferences(getString(R.string.weather_pref_key),MODE_PRIVATE);

        int length = myPref.getInt("weather_length",0);

        myArrayList.clear();

        Log.i("Week08ActStateSahredPref","start to get share preference, length is " + length);

        for(int i=0;i<length;i++) {
            myArrayList.add(myPref.getString("weather_day" + i, "no data"));
            Log.i("Week08ActStateSahredPref",myPref.getString("weather_day" + i, "no data"));
        }
...
/*
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putStringArrayList("weather_list_text",myArrayList);
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        myArrayList = savedInstanceState.getStringArrayList("weather_list_text");
    }
*/
    @Override
    protected void onStart() {
        super.onStart();
        //refreshWeather();
        Log.i("Week08ActivityLifeCycle","Main Activity onStart()");
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.i("Week08ActivityLifeCycle","Main Activity onResume()");
        displayListView();
    }
    ...
    protected void onPause() {
        super.onPause();
        Log.i("Week08ActivityLifeCycle","Main Activity onPause()");
        ...
        myEditor.putInt("weather_length",myArrayList.size());
        Log.i("Week08ActStateSahredPref","myArrayList size is " + myArrayList.size());

        for(int i=0;i<myArrayList.size();i++) {
            myEditor.putString("weather_day" + i, myArrayList.get(i).toString());
            Log.i("Week08ActStateSahredPref",myArrayList.get(i).toString());
        }
    ...
    protected void onStop() {
        super.onStop();
        Log.i("Week08ActivityLifeCycle","Main Activity onStop()");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.i("Week08ActivityLifeCycle","Main Activity onDestroy()");
    }
    ...
    public void displayListView(){
        ...
        myLV.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                myIntent.putExtra("weatherday",position);
    ...
    public class getWeatherTask extends AsyncTask<String,String,String[]>{
        ...
        protected void onPostExecute(String[] weatherresult){
            ...
            for(int i=0; i<weatherresult.length;i++) {
                ...
                //myArrayList.add(weatherresult[i]);
            }
        }
