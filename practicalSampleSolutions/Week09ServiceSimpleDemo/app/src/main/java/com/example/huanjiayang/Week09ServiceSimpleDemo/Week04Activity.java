...
import com.example.huanjiayang.Week09ServiceSimpleDemo.service.MyWeatherService;
...
public class Week04Activity extends ActionBarActivity implements LoaderManager.LoaderCallbacks<Cursor>{


    //EXTRA MILE ONLY: declare the ArrayAdapter to
    // be used with the ListView
    public SimpleCursorAdapter myArrayAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // db = DBHelper.getWritableDatabase();
        ...
        myArrayAdapter = new SimpleCursorAdapter(
                getApplicationContext(),
                R.layout.list_item,
                null,
                new String[] {WeatherDataModel.weatherEntry.COLUMN_DAY_WEATHER},
...
*/
        ...
        // Instead of starting the AsyncTask, we start the SErvice
        // with an explicit Intent
        Intent myServiceIntent = new Intent(getApplicationContext(), MyWeatherService.class);
        myServiceIntent.putExtra("city_name",city_name);
...
*/
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(getApplicationContext(),WeatherDataModel.weatherEntry.CONTENT_URI,columns,null,null,null);
    }

    @Override
    public void onLoadFinished(Loader<Cursor> loader, Cursor data) {
        myArrayAdapter.swapCursor(data);
    }

    @Override
    public void onLoaderReset(Loader<Cursor> loader) {
        myArrayAdapter.swapCursor(null);
    }
}
